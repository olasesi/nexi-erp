...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'lighthouse.query_cache.mode' => 'string',
            'lighthouse.query_cache.opcache_path' => 'string',
            ...
            'logging.channels.audit.driver' => 'string',
            'logging.channels.audit.path' => 'string',
            'logging.channels.audit.level' => 'string',
            'logging.channels.audit.days' => 'integer',
            ...
            'logging.channels.api.formatter_with.format' => 'string',
            'logging.channels.api.formatter_with.allowInlineLineBreaks' => 'boolean',
            'logging.channels.sql.driver' => 'string',
            'logging.channels.sql.path' => 'string',
            'logging.channels.sql.level' => 'string',
            'logging.channels.sql.days' => 'integer',
            'mail.default' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\nexi-erp\\public\\storage','ide-helper.filename',
...
'lighthouse.schema_cache.enable','lighthouse.schema_cache.path','lighthouse.cache_directive_tags','lighthouse.query_cache.enable','lighthouse.query_cache.mode',
'lighthouse.query_cache.opcache_path','lighthouse.query_cache.store','lighthouse.query_cache.ttl','lighthouse.validation_cache.enable','lighthouse.validation_cache.store',
...
'logging.channels.single.level','logging.channels.single.permission','logging.channels.daily.driver','logging.channels.daily.path','logging.channels.daily.level',
'logging.channels.daily.days','logging.channels.daily.permission','logging.channels.slack.driver','logging.channels.slack.url','logging.channels.slack.username',
...
'logging.channels.errorlog.replace_placeholders','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.audit.driver',
'logging.channels.audit.path','logging.channels.audit.level','logging.channels.audit.days','logging.channels.api.driver','logging.channels.api.path',
'logging.channels.api.level','logging.channels.api.days','logging.channels.api.formatter','logging.channels.api.formatter_with.format','logging.channels.api.formatter_with.allowInlineLineBreaks',
'logging.channels.sql.driver','logging.channels.sql.path','logging.channels.sql.level','logging.channels.sql.days','mail.default',
...
'scribe.database_connections_to_transact','scribe.fractal.serializer','services.postmark.key','services.resend.key','services.ses.key',
...
'debugbar.debug_backtrace_limit','tinker.commands','tinker.alias','tinker.dont_alias','tinker.trust_project',);
...
'scribe','scribe.postman','scribe.openapi','sanctum.csrf-cookie','graphql','login','password.email','password.store','logout','register',
...
'scribe::themes.elements.try_it_out','vendor.scribe.components.badges.auth','vendor.scribe.components.badges.base','vendor.scribe.components.badges.deprecated','vendor.scribe.components.badges.http-method',
'vendor.scribe.components.field-details','vendor.scribe.components.nested-fields','vendor.scribe.external.elements','vendor.scribe.external.rapidoc','vendor.scribe.external.scalar',
'vendor.scribe.markdown.auth','vendor.scribe.markdown.intro','vendor.scribe.partials.example-requests.bash.md','vendor.scribe.partials.example-requests.javascript.md','vendor.scribe.partials.example-requests.php.md',
'vendor.scribe.partials.example-requests.python.md','vendor.scribe.themes.default.endpoint','vendor.scribe.themes.default.groups','vendor.scribe.themes.default.index','vendor.scribe.themes.default.sidebar',
'vendor.scribe.themes.elements.components.field-details','vendor.scribe.themes.elements.components.nested-fields','vendor.scribe.themes.elements.endpoint','vendor.scribe.themes.elements.groups','vendor.scribe.themes.elements.index',
'vendor.scribe.themes.elements.sidebar','vendor.scribe.themes.elements.try_it_out','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.xampp.htdocs.nexi-erp.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
